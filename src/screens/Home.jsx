    ...
    return (
        <div>
            ...
            {users.map(item => (
                ...
                <div key={item.uid} onClick={() => navigate('/chat',{state: item})} className=" cursor-pointer w-11/12 shadow-md border border-black bg-blue-50 shadow-gray-300 rounded-md mx-auto py-5 px-10 flex justify-between">
